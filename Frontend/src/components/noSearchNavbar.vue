...
const canBecomeSkilled = computed(() => {
  return user.value?.role === 'resident' && !skilledProfile.value && !skilledProfileLoading.value
})
  ...
  switch (skilledProfile.value?.verification_status) {
    case 'pending':
      return {
        ...
        message:
          "Your skilled worker application is currently under review. We will notify you once it's approved.",
        color: '#f59e0b',
      }
    case 'approved':
      return {
        ...
        message:
          'Congratulations! Your application to become a skilled worker has been approved. You can now start accepting bookings.',
        color: '#10b981',
      }
    case 'rejected':
      return {
        ...
        message:
          "We're sorry, your application was not approved at this time. Please check your documents and try again.",
        color: '#ef4444',
      }
    default:
      return null
      ...
      <div class="sidenav-content">
        ...
        <div v-if="isAdmin" class="nav-section admin-section">
          ...
          <router-link to="/admin/verification" class="sidenav-link" @click="closeSideNav">
            ...
            <span v-if="skilledProfile?.verification_status === 'pending'" class="pending-count"
              >!</span
            >
          </router-link>
        ...
        <div class="nav-section" v-if="isLoggedIn">
          ...
          <div
            v-else-if="user?.role === 'resident' && skilledProfile"
            class="status-link"
          ...
          >
            <span class="link-icon" :class="skilledProfileStatus">
              ...
              >
                <path
                  v-if="skilledProfileStatus === 'pending'"
                  d="M12 8V12L15 15M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z"
                  stroke="currentColor"
                  stroke-width="1.5"
                  stroke-linecap="round"
                ...
                />
                <path
                  v-else-if="skilledProfileStatus === 'approved'"
                  d="M20 6L9 17L4 12"
                  stroke="currentColor"
                  stroke-width="1.5"
                  stroke-linecap="round"
        ...
        <div class="nav-section" v-if="isLoggedIn">
          ...
          <router-link to="/settings" class="sidenav-link" @click="closeSideNav">
            ...
            <span class="link-text">My Account Settings</span>
          </router-link>
      ...
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          <div class="status-icon" :style="{ color: getStatusMessage()?.color }">
            ...
            <svg
              v-else-if="skilledProfileStatus === 'rejected'"
              width="64"
              height="64"
              viewBox="0 0 24 24"
              fill="none"
          ...
          <div v-if="skilledProfileStatus === 'rejected'" class="status-info rejected">
            ...
            <button @click="goToBecomeSkilled" class="retry-btn">Submit New Application</button>
          </div>
          ...
          <div v-if="skilledProfileStatus === 'approved'" class="status-info approved">
            ...
            <button @click="goToSkilledProfile" class="continue-btn">Go to Worker Dashboard</button>
          </div>
        </div>
