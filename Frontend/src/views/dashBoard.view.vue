...
const loadWorkers = async () => {
    loading.value = true
    try {
        const skillName = selectedCategory.value === 'all' ? null :
...
const filteredWorkers = computed(() => {
    ...
    return workers.value.filter(worker =>
        ...
        worker.skill_name?.toLowerCase().includes(query) ||
        ...
        <main class="dashboard-main">
            ...
            <section class="hero-banner">
                <div class="hero-container">
                    <div class="hero-text">
                        <h1 class="hero-title">Find Trusted Professionals <span class="highlight">Near You</span></h1>
                    ...
                    <div class="search-container">
                        <div class="search-wrapper">
                            ...
                            <input type="text" v-model="searchQuery" placeholder="Search by name, skill, or keyword..."
                                class="search-field" />
                        </div>
                    </div>
                </div>
            ...
            <section class="workers-wrapper">
                        ...
                        <div class="card-actions">
                            ...
                            <button @click="openQuickBook(worker)" class="action-button quick-btn">
                                <span class="btn-icon">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13 3L21 12L13 21M3 3L11 12L3 21" stroke="currentColor"
                ...
                <div v-else class="empty-container">
                    ...
                    <button @click="searchQuery = ''; selectedCategory = 'all'" class="reset-button">
                        Reset Filters
                    </button>
                </div>
            </section>
                ...
                <div class="modal-panel" @click.stop>
                    ...
                    <div class="modal-body">
                        <div v-if="selectedWorker" class="worker-preview">
                            <img :src="workerImage(selectedWorker)" :alt="selectedWorker.fullName"
                                class="preview-image">
                        ...
                        <div class="booking-form">
                            <div class="form-field">
                                ...
                                <input type="date" v-model="quickBooking.date" :min="minDate" class="field-input"
                                    required />
                            </div>
