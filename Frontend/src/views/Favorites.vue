            ...
            <div v-else-if="favorites.length > 0" class="favorites-grid">
                <div v-for="worker in favorites" :key="worker.skilled_id" class="favorite-card">
                    <div class="card-image">
                        ...
                        <button @click="removeFavorite(worker.skilled_id)" class="remove-fav-btn"
                    ...
                    <div class="card-actions">
                        <button @click="viewProfile(worker.skilled_id)" class="btn-view">
                            View Profile
                        </button>
                        <button @click="bookNow(worker.skilled_id)" class="btn-book">
                            Book Now
                        </button>
                    </div>
                </div>
        ...
        <div v-if="showRemoveModal" class="modal-overlay" @click="closeRemoveModal">
            <div class="modal-content" @click.stop>
                ...
                <div class="modal-body">
                    <p>Are you sure you want to remove <strong>{{ workerToRemove?.fullName }}</strong> from your
                        favorites?</p>
                </div>
...
const confirmRemove = async () => {
    ...
    try {
        ...
        favorites.value = favorites.value.filter(f => f.skilled_id !== workerToRemove.value.skilled_id)
        closeRemoveModal()
    } catch (error) {
