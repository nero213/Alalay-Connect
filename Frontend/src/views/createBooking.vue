...
const isFormValid = computed(() => {
  return (
    form.date && selectedSlot.value && form.duration && form.address && form.city && form.barangay
  )
})
      ...
      <div class="booking-content">
        ...
        <div class="professional-card" v-if="professional">
          ...
          <div class="professional-info">
            ...
            <div class="rating">
              <span class="stars">{{
                '★'.repeat(Math.floor(professional.average_rating || 0))
              }}</span>
