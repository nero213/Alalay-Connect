...
<template>
  <div class="public-profile">
            ...
            <div class="profile-title-section">
              ...
              <div class="profile-badges">
                <div class="badge-item">
                  ...
                  <span
                    >{{ professional.barangay || 'Location' }},
          ...
          <div class="grid-main">
            ...
            <section class="content-card">
              ...
              <div class="skills-container">
                ...
                <p v-if="!professional.skills?.length" class="empty-text">No skills listed yet</p>
              </div>
            </section>
                  ...
                  <div class="average-box">
                    ...
                    <div class="average-stars">
                      <span class="stars-display">{{
                        getRatingStars(ratingStats.average_rating)
                      }}</span>
                  ...
                  <div class="distribution-box">
                    <div v-for="star in [5, 4, 3, 2, 1]" :key="star" class="distribution-row">
                      ...
                      <span class="distribution-value">{{
                        ratingStats.distribution[star]?.count
                      }}</span>
                    </div>
                  </div>
                </div>
                  ...
                  >
                    <div class="review-header">
                      <div class="reviewer-info">
                        <img
                          :src="getImageUrl(review.client_image)"
    ...
    <RatingModal
      ...
      :skilledId="professional?.skilled_id"
    ...
    <ReportModal
      ...
      reportType="Profile"
      :reportedUserId="professional?.user_id"
      :reportedSkillId="professional?.skilled_id"
