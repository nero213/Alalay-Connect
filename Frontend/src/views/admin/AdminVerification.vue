                    ...
                    <div v-for="profile in profiles" :key="profile.skilled_id" class="profile-card">
                        ...
                        <div class="profile-details">
                            ...
                            <div class="detail-section">
                                <h4>
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M14.7 6.3L19 2L20.7 3.7L16.4 8" stroke="currentColor"
                                            stroke-width="1.5" />
                                ...
                                <div class="skills-list">
                                    <span v-for="skill in profile.skills?.split(',') || []" :key="skill"
                                        class="skill-tag">
                                        {{ skill.trim() }}
                                    </span>
                            ...
                            <div class="detail-section">
                                ...
                                <div class="documents">
                                    <a v-if="profile.gov_id" :href="getFullUrl(profile.gov_id)" target="_blank"
                                        class="doc-link">
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13 3H4V21H20V8M13 3L20 10M13 3V10H20" stroke="currentColor"
                                                stroke-width="1.5" />
                                        </svg>
                                        Government ID
                                    </a>
                                    <a v-if="profile.certificate" :href="getFullUrl(profile.certificate)"
                                    ...
                                    <span v-if="!profile.gov_id && !profile.certificate" class="no-data">No documents
                                        uploaded</span>
                                </div>
                            </div>
                        ...
                        <div class="profile-actions">
                            <div class="notes-wrapper">
                                ...
                                <textarea v-model="adminNotes[profile.skilled_id]" placeholder="Add notes (optional)"
